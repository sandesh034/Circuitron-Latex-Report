...
It is clear from both \cref{fig:map50-epochs} and \cref{fig:map50-95-epochs} that the \gls{map} scores for \gls{yolo}v7 are significantly better than that for \gls{yolo}v5. Likewise, the loss curves, as shown in the previous figures, demonstrate a steeper curve in the case of YOLOv7.
...
\subsubsection{Class-wise Data Statistics}

\begin{table}[H]
    \centering
    \caption{Frequency of Each Class in the \gls{cghd} Dataset}
    \label{table:component-classes}
    \small
    \begin{tabular}{p{1.2cm}p{5cm}p{1.5cm}}
        \toprule
        \textbf{Code} & \textbf{Class Name} & \textbf{Count} \\
        \midrule
        1 & text & 91,122 \\
        2 & junction & 79,202 \\
        3 & crossover & 10,180 \\
        ...
        7 & voltage.dc & 335 \\
        8 & voltage.ac & 292 \\
        9 & voltage.battery & 765 \\
        10 & resistor & 14,400 \\
        11 & resistor.adjustable & 1,052 \\
        12 & resistor.photo & 65 \\
        13 & capacitor.unpolarized & 5,841 \\
        14 & capacitor.polarized & 2,227 \\
        15 & capacitor.adjustable & 88 \\
        16 & inductor & 1,976 \\
        17 & inductor.ferrite & 120 \\
        18 & inductor.coupled & 10 \\
        19 & transformer & 483 \\
        20 & diode & 3,890 \\
        21 & diode.light\_emitting & 1,212 \\
        22 & diode.thyrector & 16 \\
        23 & diode.zener & 609 \\
        24 & diac & 40 \\
        25 & triac & 98 \\
        26 & thyristor & 415 \\
        27 & varistor & 184 \\
        28 & transistor.bjt & 3,678 \\
        29 & transistor.fet & 977 \\
        30 & transistor.photo & 177 \\
        31 & operational\_amplifier & 752 \\
        32 & operational\_amplifier.schmitt\_trigger & 16 \\
        33 & optocoupler & 162 \\
        34 & integrated\_circuit & 1,506 \\
        35 & integrated\_circuit.ne555 & 262 \\
        36 & integrated\_circuit.voltage\_regulator & 362 \\
        37 & xor & 162 \\
        38 & and & 860 \\
        39 & or & 440 \\
        40 & not & 496 \\
