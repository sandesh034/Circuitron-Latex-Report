...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.85\textwidth}{\centering [Figure Placeholder 6-1: Loss Curves for YOLOv5 showing Bounding Box Loss, Objectness Loss, and Classification Loss across epochs]}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.85\textwidth}{\centering [Figure Placeholder 6-2: Loss Curves for YOLOv7 showing Bounding Box Loss, Objectness Loss, and Classification Loss across epochs]}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.85\textwidth}{\centering [Figure Placeholder 6-3: mAP@0.5 vs Epochs for YOLOv5 and YOLOv7, showing YOLOv7 achieving higher mAP values]}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.85\textwidth}{\centering [Figure Placeholder 6-4: mAP@0.5:0.95 vs Epochs for YOLOv5 and YOLOv7, demonstrating YOLOv7 superiority]}}
    \caption{\gls{map}@0.5:0.95 vs Epochs for YOLOv5 and YOLOv7}
    \label{fig:map50-95-epochs}
\end{figure}

It is clear from both \cref{fig:map50-epochs} and \cref{fig:map50-95-epochs} that the \gls{map} scores for \gls{yolo}v7 are significantly better than that for \gls{yolo}v5.
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.85\textwidth}{\centering [Figure Placeholder 6-5: Precision-Confidence Curve for YOLOv5 showing precision degradation at lower confidence thresholds]}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.85\textwidth}{\centering [Figure Placeholder 6-6: Precision-Confidence Curve for YOLOv7 showing improved precision stability]}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.85\textwidth}{\centering [Figure Placeholder 6-7: Recall-Confidence Curve for YOLOv5 demonstrating recall-confidence tradeoff]}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.85\textwidth}{\centering [Figure Placeholder 6-8: Recall-Confidence Curve for YOLOv7 showing superior recall performance]}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.85\textwidth}{\centering [Figure Placeholder 6-9: F1-Confidence Curve for YOLOv5 showing optimal performance at specific thresholds]}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.85\textwidth}{\centering [Figure Placeholder 6-10: F1-Confidence Curve for YOLOv7 demonstrating better overall F1 performance]}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.85\textwidth}{\centering [Figure Placeholder 6-11: Precision-Recall (PR) Curve for YOLOv5 showing model's precision-recall tradeoff]}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.85\textwidth}{\centering [Figure Placeholder 6-12: Precision-Recall (PR) Curve for YOLOv7 demonstrating enhanced performance envelope]}}
    \caption{Precision-Recall Curve for YOLOv7}
    \label{fig:pr-curve-v7}
\end{figure}

These curves help assess how confident and consistent predictions are across threshold values. The comparative results demonstrate that \gls{yolo}v7 provides superior detection performance in terms of both accuracy and robustness across varying confidence thresholds, making it the preferred choice for the \gls{circuitron} system.
