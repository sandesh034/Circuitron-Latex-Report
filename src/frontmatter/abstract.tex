...
mAP@0.5 of 83\% for component detection, and expects character accuracy of 85\% for 
...
\vspace{1em}
\noindent\textit{\textbf{Keywords}}--- circuit recognition, object detection, SPICE netlist, text recognition, wire 
detection .