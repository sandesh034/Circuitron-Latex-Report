...
% Software/Tools - defined as commands (not in abbreviation list)
% These can still be used with \gls{key} syntax via glsxtrnewsymbol or directly
\newcommand{\glspython}{Python}
\newcommand{\glsngspice}{NgSpice}
\newcommand{\glspyspice}{PySpice}
\newcommand{\glsltspice}{LTspice}
\newcommand{\glseasyocr}{EasyOCR}
\newcommand{\glsrestful}{RESTful}
\newcommand{\glscircuitron}{Circuitron}
\newcommand{\glsuk}{UK}

% Redefine \gls for these specific terms to use the commands
\let\oldgls\gls
\renewcommand{\gls}[1]{%
    \ifcsname gls#1\endcsname
